    ...
    display(context, program_state) {
        ...
        if (!context.scratchpad.controls) {
            ...
            if(matrix === this.initial_camera_location){
                ...
                program_state.set_camera(Mat4.inverse(matrix));
            }
        }
        ...
        this.shapes.sun.draw(context, program_state, model_transform, this.materials.test.override({color: red}));
...
class Ring_Shader extends Shader {
    ...
    fragment_glsl_code() {
        ...
        return this.shared_glsl_code() + `
        void main(){
          gl_FragColor = vec4(cos( 19.0 * (1. + length(point_position.xyz-center.xyz))));
        }`;
    }
}
